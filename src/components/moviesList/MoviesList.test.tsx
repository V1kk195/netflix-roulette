...
describe("movies list", () => {
    test("renders correctly", () => {
        ...
        expect(screen.getByText(/2500 movies found/i)).toBeVisible();
        ...
        expect(
            screen.getByRole("heading", {
                name: /fifty shades freed/i,
            })
        ).toBeVisible();

        expect(
            screen.getByRole("img", {
                name: /star wars: the last jedi poster/i,
            })
        ).toBeVisible();
        expect(
            screen.getByRole("heading", {
                name: /star wars: the last jedi/i,
            })
        ).toBeVisible();
    });
});
